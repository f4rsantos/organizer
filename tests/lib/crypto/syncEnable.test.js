...
import { enableSyncEncryption, updatePassphrase, replaceRecoveryCode, updateHint } from '../../../src/lib/crypto/syncEnable.js'
import { closeDekStore, getCachedDek } from '../../../src/lib/crypto/keyStore.js'
import { unwrapDek, hasAnySlot, getHint, SLOT_PASSPHRASE, SLOT_RECOVERY_CODE } from '../../../src/lib/crypto/wraps.js'
import { decodeSlices } from '../../../src/lib/crypto/sliceCodec.js'
import { aadForPersonalSlice } from '../../../src/lib/crypto/aad.js'
...
function fakeRemote() {
  ...
  return {
    ...
    pushContainer: async ({ state, dek, wraps, dekId }) => {
      doc.value = {
        ...await import('../../../src/lib/crypto/sliceCodec.js').then(m => m.encodeSlices({
