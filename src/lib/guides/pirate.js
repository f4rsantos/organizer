  ...
  entries: {
    ...
    habits: {
      ...
      body: [
        ...
        'Yer history builds into a calendar below, seven days to a row, with a wee dot markin\' any day outside yer run. It starts as a single row an\' spreads into fresh rows an\' moons as ye go, so early days stay readable an\' long runs stay lined up. The buttons up top let ye read the log, scratch the present mark, or scuttle the quest entire.',
      ],
    },
    eisenhower: {
