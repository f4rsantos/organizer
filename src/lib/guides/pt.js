export const pt = {
  ...
  entries: {
    ...
    habits: {
      ...
      body: [
        'Um hábito é algo que queres continuar a fazer, e não terminar de uma vez. Cada hábito mostra um botão cinzento à espera de ser premido; ao premi-lo marcas o período atual como feito, aparece uma pequena celebração e vês há quanto tempo dura a tua sequência.',
        'Ao criares um hábito escolhes com que frequência deve ser clicado, desde todos os dias até uma vez por mês, e se queres escrever uma nota curta de cada vez. Vale a pena ativar as notas quando te importa como correu, e não apenas que aconteceu.',
        'O teu histórico forma um calendário por baixo, sete dias por linha, com um pequeno ponto a marcar qualquer dia fora da tua sequência. Começa numa única linha e cresce em novas linhas e meses à medida que avanças, para que os primeiros dias fiquem legíveis e as sequências longas se mantenham alinhadas. Os botões no cabeçalho permitem rever o progresso, anular o clique atual ou eliminar o hábito.',
      ],
    },
    eisenhower: {
