export const cs = {
  ...
  entries: {
    ...
    habits: {
      ...
      body: [
        'Návyk je něco, v čem chceš pokračovat, ne něco, co jednou dokončíš. Každý návyk ukazuje jediné šedé tlačítko, které čeká na stisk. Stisknutím označíš aktuální období za splněné, spustí se malá oslava a uvidíš, jak dlouhá je tvoje série.',
        'Při vytváření návyku vybereš, jak často se má mačkat, od každého dne až po jednou za měsíc, a jestli chceš pokaždé napsat krátkou poznámku. Poznámky se vyplatí zapnout, když ti záleží na tom, jak to šlo, ne jen na tom, že se to stalo.',
        'Tvoje historie se pod tím skládá do kalendáře, sedm dní na řádek, s malou tečkou u každého dne mimo tvoji sérii. Začíná jediným řádkem a roste do nových řádků a měsíců, jak postupuješ, takže první dny zůstanou čitelné a dlouhé série zůstanou zarovnané. Tlačítka v záhlaví umožní projít pokrok, vrátit aktuální klik nebo návyk smazat.',
      ],
    },
    eisenhower: {
