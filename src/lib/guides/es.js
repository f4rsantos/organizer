export const es = {
  ...
  entries: {
    ...
    habits: {
      ...
      body: [
        'Un hábito es algo que quieres seguir haciendo en lugar de terminar una sola vez. Cada hábito muestra un único botón gris esperando a ser pulsado: al pulsarlo marcas el periodo actual como hecho, salta una pequeña celebración y ves cuánto dura tu racha.',
        'Al crear un hábito eliges con qué frecuencia hay que pulsarlo, desde cada día hasta cada mes, y si quieres anotar unas palabras cada vez. Las notas merecen la pena cuando te importa cómo fue, y no solo que ocurriera.',
        'Tu historial se convierte en un calendario debajo, siete días por fila, con un pequeño punto marcando cualquier día fuera de tu racha. Empieza como una sola fila y crece en nuevas filas y meses a medida que avanzas, de modo que los primeros días siguen siendo legibles y las rachas largas se mantienen alineadas. Los botones de la cabecera permiten repasar el progreso, deshacer el clic actual o eliminar el hábito.',
      ],
    },
    eisenhower: {
