export const pt = {
  ...
  mutationVerbs: {
    ...
    atribuir: { type: 'mut', action: 'assign' },
    atribui: { type: 'mut', action: 'assign' },
    'atribuir a': { type: 'mut', action: 'assign' },
    designar: { type: 'mut', action: 'assign' },
    designa: { type: 'mut', action: 'assign' },
