...
import { GOAL_WHEEL_SIZE } from './cellSize'

export function GoalCheckInButton({ done, restDay = false, label, onClick, pct = 0 }) {
  if (done) {
    return (
      <div style={{ width: GOAL_WHEEL_SIZE, height: GOAL_WHEEL_SIZE }}>
        <SvgProgressWheel pct={pct} size={GOAL_WHEEL_SIZE} strokeWidth={10} celebrate />
      </div>
    )
  }
  ...
  return (
    <button
      ...
      style={{ width: GOAL_WHEEL_SIZE, height: GOAL_WHEEL_SIZE }}
    >
