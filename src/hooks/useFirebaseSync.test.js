...
import { resetStateDb } from '@/store/testStorage'
import { useStore } from '@/store/useStore'
import { setInitialSyncRev, getInitialSyncRev, resetInitialSyncRevForTests } from './useFirebaseSync'
...
describe('useFirebaseSync module exports', () => {
  it('provides the sync hook and initial sync controls', async () => {
    ...
    const { useFirebaseSync } = await import('./useFirebaseSync')
...
describe('useHydrateState with remote data', () => {
  it('loads remote data when firebase is configured', async () => {
    ...
    const { useHydrateState } = await import('./useHydrateState')
